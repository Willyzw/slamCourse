...
def estimate_transform(left_list, right_list, fix_scale = False):
    ...
    for i in range(len(left_list)):
        lstich = subtract(left_list[i], lc)
        rstich = subtract(right_list[i], rc)
        cs += rstich[0]*lstich[0] + rstich[1]*lstich[1]
        ss +=-rstich[0]*lstich[1] + rstich[1]*lstich[0]
        rr += rstich[0]*rstich[0] + rstich[1]*rstich[1]
        ll += lstich[0]*lstich[0] + lstich[1]*lstich[1]
